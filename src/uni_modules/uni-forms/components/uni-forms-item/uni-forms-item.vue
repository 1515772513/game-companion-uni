  ...
  <view class="uni-forms-item" :class="{ 'uni-forms-item--border': border, 'is-first-border': border && isFirstBorder, 'uni-forms-item-error': msg }">
    <view class="uni-forms-item__box">
      <view
        ...
        :class="['is-direction-' + labelPos, 'border-theme-' + $thirdConfigS.themeConfig.className, 'text-main-theme-' + $thirdConfigS.themeConfig.className]"
      >
        <view class="uni-forms-item__label" :class="{ 'is-input-error-border': msg }" :style="{ width: labelWid, justifyContent: justifyContent }">
          <slot name="label">
            <text v-if="required" class="is-required">*</text>
            <uni-icons v-if="leftIcon" class="label-icon" size="16" :type="leftIcon" :color="iconColor" />
            <text class="label-text" :class="'text-label-theme-' + $thirdConfigS.themeConfig.className">{{ label }}</text>
